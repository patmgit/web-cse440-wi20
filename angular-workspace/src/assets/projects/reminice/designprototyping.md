...
<img src="onboarding_4.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Onboarding screen introducing more elements of remi-nice to the user">
<img src="onboarding_5.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Onboarding screen introducing more elements of remi-nice to the user">
<img src="onboarding_6.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Final paper prototype onboarding screen welcoming the user to the app and prompting them to get started">
</p>
...
<img src="add_journal_4.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Screen for confirming and uploading checked selections">
</p>

#### Calendar View, Search, and Statistics

<img src="calendar.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Final paper prototype screen showing the calendar with options to search, see stats, and filter by type of memory">
<img src="search.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Screen showing an example of the search page and how it uses keywords to return memory results">
<img src="stats.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Screen showing the stats based on the calendar, based on types of memories, days, and other trends">
...
<img src="digital_on_3.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Onboarding/explanation screen for the app ">
<img src="digital_on_4.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Onboarding/explanation screen for the app explaining service inclusion ">
<img src="digital_on_5.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Onboarding/explanation screen for the app explaining physical journal uploading ">
<img src="digital_on_6.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Digital mockup of the account creation screen, asking for name, email, and password ">
<img src="digital_on_8.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Digital mockup of page showing services that can be connected, all unchecked">
<img src="digital_on_9.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Digital mockup of page showing services that can be connected, with some selected ones checked with a green check">
</p>
...
<img src="digital_day_3" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Screen showing day's story after content was added, with option to add/delete/share">
</p>
...
<img src="digital_delete_4.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="'Your story' screen demonstrating the delete functionality, with certain memories selected with green checks ">
<img src="digital_delete_5.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="Updated 'Your story' page after">
</p>
...
<img src="digital_share_4.jpg" width="25%" style="max-width: 110px; display: block; margin: auto;" alt="'Your story' screen demonstrating the sharing functionality, with certain memories selected with green checks ">
</p>
